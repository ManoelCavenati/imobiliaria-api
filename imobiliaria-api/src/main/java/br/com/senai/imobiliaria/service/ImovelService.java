package br.com.senai.imobiliaria.service;
...
import br.com.senai.imobiliaria.exception.RegistroExistenteException;
import br.com.senai.imobiliaria.exception.RegistroNaoEncontradoException;
import br.com.senai.imobiliaria.model.Imovel;
import br.com.senai.imobiliaria.repository.ImovelRepository;
...
public class ImovelService {
    ...
    public Imovel atualizar(Imovel dadosAtualizados) {
        ...
        imovelBD.setBairro(dadosAtualizados.getBairro());
        imovelBD.setCidade(dadosAtualizados.getCidade());
